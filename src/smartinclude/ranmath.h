...
void ewens(int *a, int n, double theta) ;  // ewens sampling formula  
void genmultgauss(double *rvec, int num, int n, double *covar) ;  // multivariate 
double drand2() ;  // obsolete  
...
void randirmult(double *pp, int *aa, int len, int m) ;  // diirichlet multinomial.  Output aa
int prob1(double p) ;
